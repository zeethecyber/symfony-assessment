...
class SerializerConfig
{
     ...
     */
    public function symfonySerializer(array $value = []): Serializer\SymfonySerializerConfig
    {
        if (null === $this->symfonySerializer) {
            $this->_usedProperties['symfonySerializer'] = true;
            $this->symfonySerializer = new Serializer\SymfonySerializerConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('symfony_serializer', $value)) {
            $this->_usedProperties['symfonySerializer'] = true;
            $this->symfonySerializer = new Serializer\SymfonySerializerConfig($value['symfony_serializer']);
