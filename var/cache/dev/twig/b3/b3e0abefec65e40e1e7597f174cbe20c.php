...
class __TwigTemplate_b0e775c40c60e2a16f2c30eba6797d65 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $context['status_code'] = ((isset($context['request_collector']) || array_key_exists('request_collector', $context) ? $context['request_collector'] : (function () { throw new RuntimeError('Variable "request_collector" does not exist.', 1, $this->source); })()) ? ((CoreExtension::getAttribute($this->env, $this->source, $context['request_collector'] ?? null, 'statuscode', [], 'any', true, true, false, 1)) ? (CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context['request_collector'] ?? null, 'statuscode', [], 'any', false, false, false, 1), 0)) : (0)) : (0));
        // line 2
...
';
    ...
    <div class="status status-compact status-warning">
        <span class="icon icon-redirect">';
            // line 10
            yield CoreExtension::source($this->env, '@WebProfiler/Icon/redirect.svg');
            yield '</span>
...
<div class="status ';
    ...
    ';
        ...
        if ((isset($context['status_code']) || array_key_exists('status_code', $context) ? $context['status_code'] : (function () { throw new RuntimeError('Variable "status_code" does not exist.', 27, $this->source); })()) > 399) {
            ...
            <span class="icon">';
            // line 29
            yield CoreExtension::source($this->env, '@WebProfiler/Icon/alert-circle.svg');
            yield '</span>
    ...
    <h2>
        <span class="status-request-method">
            ';
        // line 37
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::upper($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, isset($context['profile']) || array_key_exists('profile', $context) ? $context['profile'] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 37, $this->source); })(), 'method', [], 'any', false, false, false, 37)), 'html', null, true);
        yield '
        </span>

        ';
        // line 40
        $context['profile_title'] = ((CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, isset($context['profile']) || array_key_exists('profile', $context) ? $context['profile'] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 40, $this->source); })(), 'url', [], 'any', false, false, false, 40)) < 160) ? (CoreExtension::getAttribute($this->env, $this->source, isset($context['profile']) || array_key_exists('profile', $context) ? $context['profile'] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 40, $this->source); })(), 'url', [], 'any', false, false, false, 40)) : (CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, isset($context['profile']) || array_key_exists('profile', $context) ? $context['profile'] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 40, $this->source); })(), 'url', [], 'any', false, false, false, 40), 0, 160).'…'));
        // line 41
        yield '        ';
        if (CoreExtension::inFilter(CoreExtension::upper($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, isset($context['profile']) || array_key_exists('profile', $context) ? $context['profile'] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 41, $this->source); })(), 'method', [], 'any', false, false, false, 41)), ['GET', 'HEAD'])) {
            // line 42
            yield '            <a href="';
    ...
    <dl class="metadata">
        ...
        if (isset($context['referer']) || array_key_exists('referer', $context) ? $context['referer'] : (function () { throw new RuntimeError('Variable "referer" does not exist.', 58, $this->source); })()) {
            ...
            // line 61
            yield CoreExtension::source($this->env, '@WebProfiler/Icon/referrer.svg');
            yield '</span>
                <a href="';
            // line 62
...
';
        ...
        <span class="icon icon-forward">';
            // line 83
            yield CoreExtension::source($this->env, '@WebProfiler/Icon/forward.svg');
            yield '</span>
        ...
        ';
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, $context['controller'] ?? null, 'class', [], 'any', true, true, false, 89)) {
                // line 90
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::striptags($this->extensions['Symfony\Bundle\WebProfilerBundle\Profiler\CodeExtension']->abbrClass($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, isset($context['controller']) || array_key_exists('controller', $context) ? $context['controller'] : (function () { throw new RuntimeError('Variable "controller" does not exist.', 90, $this->source); })(), 'class', [], 'any', false, false, false, 90), 'html', null, true))), 'html', null, true);
                // line 91
    ...
    {
        return [279 => 96,  275 => 95,  272 => 93,  269 => 91,  267 => 90,  265 => 89,  257 => 88,  255 => 87,  248 => 83,  245 => 82,  242 => 81,  240 => 80,  238 => 79,  231 => 75,  223 => 72,  214 => 68,  209 => 65,  203 => 62,  199 => 61,  195 => 59,  192 => 58,  190 => 57,  187 => 56,  181 => 53,  177 => 52,  173 => 50,  171 => 49,  166 => 46,  160 => 44,  152 => 42,  149 => 41,  147 => 40,  141 => 37,  136 => 34,  130 => 31,  126 => 30,  122 => 29,  119 => 28,  117 => 27,  113 => 26,  110 => 25,  102 => 22,  99 => 21,  93 => 19,  83 => 17,  81 => 16,  76 => 14,  71 => 12,  66 => 10,  62 => 8,  59 => 7,  56 => 6,  53 => 5,  51 => 4,  48 => 3,  46 => 2,  44 => 1];
    }
...
{%- endif %}
", '@WebProfiler/Profiler/_request_summary.html.twig', '/Users/ahmed/Herd/products_api/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/_request_summary.html.twig');
    }
}
