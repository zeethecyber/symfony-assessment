...
class __TwigTemplate_447b16750859c049d084f920ddf90fed extends Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })(), 'dumpsCount', [], 'any', false, false, false, 4)) {
            ...
            $context['icon'] = ('' === $tmp = CoreExtension::captureOutput((function () use (&$context) {
                // line 6
                yield '            ';
                yield CoreExtension::source($this->env, '@Debug/Profiler/icon.svg');
                yield '
        ...
        ';
            // line 35
            yield CoreExtension::include($this->env, $context, '@WebProfiler/Profiler/toolbar_item.html.twig', ['link' => true]);
            yield '
    ';
        }
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        yield (0 == CoreExtension::getAttribute($this->env, $this->source, isset($context['collector']) || array_key_exists('collector', $context) ? $context['collector'] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 40, $this->source); })(), 'dumpsCount', [], 'any', false, false, false, 40)) ? ('disabled') : ('');
        yield '">
        <span class="icon">';
        // line 41
        yield CoreExtension::source($this->env, '@Debug/Profiler/icon.svg');
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", '@Debug/Profiler/dump.html.twig', '/Users/ahmed/Herd/products_api/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig');
    }
}
