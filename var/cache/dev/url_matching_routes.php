...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/products' => [
            [['_route' => 'product_index', '_controller' => 'App\\Controller\\ProductController::index'], null, ['GET' => 0], null, false, false, null],
            [['_route' => 'product_store', '_controller' => 'App\\Controller\\ProductController::store'], null, ['POST' => 0], null, false, false, null],
        ],
